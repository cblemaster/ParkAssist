...
namespace ParkAssist.API.Models
{
    ...
    {
        public AdminDTO Map<T>(Admin admin) where T : Admin => new()
        {
            AdminId = admin.Id,
            UserId = admin.UserId,
        ...
        public ValetDTO Map<T>(Valet valet) where T : Valet => new()
        {
            ValetId = valet.Id,
            UserId = valet.UserId,
        ...
        public CustomerDTO Map<T>(Customer customer) where T : Customer => new()
        {
        ...
        public OwnerDTO Map<T>(Owner owner) where T : Owner => new()
        {
            OwnerId = owner.Id,
            UserId = owner.UserId,
        ...
        public ParkingLotDTO Map<T>(ParkingLot parkingLot) where T : ParkingLot => new()
        {
